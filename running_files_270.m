...
% filename1 = sprintf('Lengkap_%s_%s_%s_%d.xlsx',res,traj,typ,4);
% filename2 = sprintf('Complex_%s_%s_%s_%d.csv',res,traj,typ,4);
%     
...
csvwrite('Komplit_VECTOR_1ATraj_90M-10H_100_NO-HF_4.csv',Tmat)

csvwrite('Complex_VECTOR_1ATraj_90M-10H_100_NO-HF_4.csv',complex)
