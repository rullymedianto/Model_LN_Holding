...
%          
          plotwaypoint2 = scatter(NavData(1:30,1),NavData(1:30,2),5,'filled','b'); %Arr WP
          txt2a = text(NavData(1:30,1),NavData(1:30,2),label(1:30,1),'FontSize',5,'HorizontalAlignment','right');
