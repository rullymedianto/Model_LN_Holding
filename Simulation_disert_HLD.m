            ...
            for c2 = 1:airplane
                ...
                if c1 == c2 || Sim1{1,i}(4,c1) >= 9000000 || Sim1{1,i}(4,c2) >= 9000000
                    ...
                    Distance_Altitude{1,i}(c1,c2) = sqrt((Sim1{1,i}(4,c1) - Sim1{1,i}(4,c2)).^2); %% Vertical distance
                        if (Sim1{1,i}(27,c1)~= Sim1{1,i}(27,c2)) && ((Sim1{1,i}(27,c1)==1 && Sim1{1,i}(27,c2) ==3)||(Sim1{1,i}(27,c2)==1 && Sim1{1,i}(27,c1) ==3)||(Sim1{1,i}(27,c2)==2 && Sim1{1,i}(27,c1) ==3)||(Sim1{1,i}(27,c1)==2 && Sim1{1,i}(27,c2) ==3)||(Sim1{1,i}(27,c2)==1 && Sim1{1,i}(27,c1) ==2)||(Sim1{1,i}(27,c1)==1 && Sim1{1,i}(27,c2) ==2))
...
if Sim1{1,i+1}(1,j)==2 && Sim1{1,1}(27,i)==1
...
con_proport(2,i+1)=sum(con_prop{1,i+1}(1,:)); %Jumlah BIP
con_proport(3,i+1)= sum(Sim1{1,i+1}(29,:)); %Jumlah pesawat di sektor
...
max_potensi_conflictinsector = max(complex(10,:));
mean_potensi_conflictinsector = mean(complex(10,:));
