function [y, crossing] = clearance(ROW,conflict,airplane,j,distance,buffer_zone_1,buffer_zone_2,height,hold_status,conflict3,distancemerg)
...
elseif conflict(1,j) == 1 || conflict3(1,j)==1
    if column1 == 1
       ...
       elseif it_2(2,column1-1) == 1 && distance(j,k) < buffer_zone && distance(j,k)~= 0 %%Revisi di sini
           y = 0;
