...
% filename1 = sprintf('Lengkap_%s_%s_%s_%d.xlsx',res,traj,typ,3);
% filename2 = sprintf('Complex_%s_%s_%s_%d.csv',res,traj,typ,3);
%     
...
csvwrite('Komplit_VECTOR_1ATraj_90M-10H_100_NO-HF_3.csv',Tmat)

csvwrite('Complex_VECTOR_1ATraj_90M-10H_100_NO-HF_3.csv',complex)


% T = cell2table(compl_total);
% writetable(T,'Kom_CekComp_1S_1ATraj_100Med_210dtk_a.csv')
% 
...
% writetable(TS,'CekComp_1S_1ATraj_100Med_210dtk_a.csv')

% writematrix(complex,'Complex_1S_1ATraj_100Med_210dtk_a.csv')
