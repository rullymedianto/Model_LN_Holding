...
% inter = IAT;
Tmat=cell2mat(compl_total);

% filename1 = sprintf('Lengkap_%s_%s_%s_%d.xlsx',res,traj,typ,2);
% filename2 = sprintf('Complex_%s_%s_%s_%d.csv',res,traj,typ,2);
%     
% % writetable(T,'Kom_CekComp_1S_2ABTraj_100Med_270dtk_a.csv')
% 
% xlswrite(fullfile(dire,filename1),Tmat)
% % xlswrite(fullfile(dil,filename2),complex)
% 
% csvwrite(fullfile(dire,filename2),complex)

csvwrite('Komplit_VECTOR_1ATraj_90M-10H_100_NO-HF_2.csv',Tmat)

csvwrite('Complex_VECTOR_1ATraj_90M-10H_100_NO-HF_2.csv',complex)


% T = cell2table(compl_total);
% writetable(T,'Kom_CekComp_1S_1ATraj_100Med_150dtk_a.csv')
% 
...
% writetable(TS,'CekComp_1S_1ATraj_100Med_150dtk_a.csv')
% 
% writematrix(complex,'Complex_1S_1ATraj_100Med_150dtk_a.csv')
